...
public class TentativeFinalGrade {
  ...
  public static int readInt(String promptMessage) {
    ...
    System.out.print(promptMessage + " : ");
    input = kbd.nextLine();
    value = Integer.valueOf(input); // No. 2
    return value;
  }
  ...
  public static void showStudent(String n, int p, int m, int t, int f) {
    ...
    if (t > 100) { // No. 4 Check if it exceeds 100
      System.out.println(
        " Sorry! It is impossible to get your desired final grade."
      );
      System.out.println(
        "The highest grade that you can get if you get perfect scores " +
        "in all final requirements is " +
        (p + m + 100) /
        3 +
        "."
      );
  ...
  public static void main(String[] args) { // No. 5 main method header
    try (Scanner kbd = new Scanner(System.in)) {
      ...
      int prelimGrade = 50, midtermGrade = 50, desiredFinalGrade =
        50, neededTentativeFinalGrade = 50;
      while (wantToCompute == 'y' || wantToCompute == 'Y') {
        ...
        neededTentativeFinalGrade =
          computeRequiredTFG(prelimGrade, midtermGrade, desiredFinalGrade);
        showStudent(
          studName,
          prelimGrade,
          midtermGrade,
        ...
        wantToCompute = kbd.nextLine().charAt(0);
      }
    }
    System.exit(0);
  } // end of main method
